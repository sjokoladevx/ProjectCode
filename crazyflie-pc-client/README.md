**IMPORTANT NOTICE**: This repository and tracker has been moved to GitHub and is now located at [http://www.github.com/bitcraze/crazyflie-clients-python](http://www.github.com/bitcraze/crazyflie-clients-python/ "Crazyflie Python clients at GitHub"). This repository will be keept for referance, but will no longer be updated.
